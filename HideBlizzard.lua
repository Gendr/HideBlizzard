        ...
        info = {
          ...
          args = {
            version = {
              ...
              name = format("v%.1f-|cff0080FFclassic|r", GetAddOnMetadata(addonName, "Version")),
            },
            reset = {
...
function HideBlizzard:OnInitialize()
  ...
  LibStub("AceConfigRegistry-3.0"):RegisterOptionsTable("HideBlizzard", SetupOptions)
  LibStub("AceConfigDialog-3.0"):AddToBlizOptions("HideBlizzard", "HideBlizzard")
